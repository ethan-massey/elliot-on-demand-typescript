...
export class S3Service {
    ...
    constructor() {
        if (!process.env.S3_ACCESS_KEY_ID || !process.env.S3_SECRET_ACCESS_KEY) {
            throw new Error('process.env.S3_ACCESS_KEY_ID or process.env.S3_SECRET_ACCESS_KEY is not defined.')
        }
    ...
    public async uploadChunk(fileName: string, chunk: Buffer, chunkNumber: number, UploadId: string | undefined) {
    ...
    public async finishMultiPartUpload(fileName: string, UploadId: string | undefined, Parts: any) {
