    ...
    rss: [
      { _attr: { version: "2.0" } },
      {
        channel: [
          ...
          { description: [""] },
          { item: [{ title: ['Fri Mar 28 2025'] }, { link: ['https://d2bso5f73cpfun.cloudfront.net/2025-03-28T05:45:00.mp3'] }, { description: ['- EITM: Katie Pumphrey 3/28/25 | swimkatie.com\n- EITM: Bride\'s Two Dads 3/28/25 | When it comes to wedding traditions, bio or step?\nEITM: Raising Canines 3/28/25 | Puppy parents and their future service dogs.'] }] },
        ],
      },
    ],
  };
